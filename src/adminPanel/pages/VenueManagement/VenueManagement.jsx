...
const VenueManagement = () => {
  ...
  const [isImageUploading, setIsImageUploading] = useState(false); // Track image upload status
  ...
  const closeModal = () => {
    ...
    setIsImageUploading(false); // Reset upload status
    setFormData({
      name: '',
      image: '',
      pricePerPlate: '',
  ...
  const handleSubmit = (e) => {
    ...
    if (mode === 'create') {
      ...
      updateMutation.mutate(
        { id: selectedVenue._id, updates: payload },
        { onSuccess: () => closeModal() }
      );
    }
  };
                ...
                <div className="md:col-span-2">
                  <label className="flex items-center">
                    ...
                    <span className="text-sm font-medium text-gray-700">
                      Active (venue is available for bookings)
                    </span>
                  </label>
                </div>
              </div>
