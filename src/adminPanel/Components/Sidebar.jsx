...
export function Sidebar() {
  ...
  const sidebarItems = [
    ...
    { id: 10, text: 'Venue Management', icon: <Group />, path: '/admin/venue-management', roles: ['superadmin', 'admin', 'manager', 'contentManager', 'cityManager', 'hotelManager', 'digitalMarketer'] },
        ...
        <nav className="h-full flex flex-col">
          <div className="p-4 pb-2 flex justify-between items-center transition-all duration-500 ease-in-out">
            <Link className={`overflow-hidden transition-all duration-500 ease-in-out ${expanded ? 'w-32' : 'w-0'}`}>
              <img src="/images/Logo/mobileLogo.svg" alt="Logo" className="w-[120px] md:w-[160px]" />
            </Link>
            <button
