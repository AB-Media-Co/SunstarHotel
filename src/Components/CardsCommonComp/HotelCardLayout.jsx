...
const HotelCard = ({ hotel,btnClass='bg-white hover:bg-yellow-400 w-[150px] m-2 hover:shadow-2xl hover:rounded-lg rounded-lg transition ease-in-out duration-300 mt-0' }) => {
    return (
        <div 
