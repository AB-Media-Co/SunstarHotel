...
const HeroSection = ({ title, highlightText, description, imageSrc }) => {
    ...
    return (
        <div className="w-full bg-[#6EC4C2] py-20 relative overflow-hidden">
            <div className="content mx-auto flex flex-col md:pt-20 lg:flex-row items-center mt-6 md:mt-0 justify-between md:gap-12">
                ...
                >
                    ...
                    <p className="text-start text-mobile/body/2 md:text-desktop/body/1 text-primary-white mb-6 whitespace-pre-line animation-on-scroll-Section1 leading-relaxed">
                        {description}
                    </p>
                </motion.div>
                ...
                >
                    <img src="/images/AbouPageImages/banner2.gif" alt="" className="absolute -top-8 md:-top-10 left-4 h-28 md:h-40" />
                    <img src="/images/AbouPageImages/banner1.gif" alt="" className="absolute top-0 right-0 h-28 md:h-40 scale-x-[-1]" />
                    ...
                    <motion.img
                        ...
                        className="relative rounded-lg max-w-full object-cover  transition-transform duration-300 ease-in-out"
                    />
                </motion.div>
            </div>
        </div>
