...
const Banner = () => {
  ...
  const email = ContactUsDetail?.emailId || "";
  const emailHref = email
    ? (email.toLowerCase().startsWith("mailto:") ? email : `mailto:${email}`)
    : undefined;

  return (
    <div className="relative h-[420px] md:h-[400px] bg-primary-green">

      <div className="content h-full flex">
        {/* Content */}
        <div className="relative z-10  flex flex-col justify-end px-6 pb-6 md:px-0 ">
          <motion.h1
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3">
              <Icon name="rotatePhone" className="w-8 h-8 md:w-10 md:h-10 transition-transform duration-300 hover:scale-110" />
              <a
            ...
            <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3">
              <Icon name="email" className="w-8 h-8 md:w-10 md:h-10 transition-transform duration-300 hover:scale-110" />
              <a
                href={emailHref}
                className="text-primary-white text-base md:text-lg font-medium hover:underline"
              >
        ...
        {/* <div className="relative">
          <img src="/images/ContctUsImg/desktop.gif" alt="1gif" />
          <img src="/images/ContctUsImg/mailbox.gif" alt="1gif" />
          <img src="/images/ContctUsImg/pot.gif" alt="1gif" />
          <img src="/images/ContctUsImg/thumb.gif" alt="1gif" />
        </div> */}
