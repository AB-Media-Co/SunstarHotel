...
const HotelIImageCarousel = ({ data }) => {
  ...
  return (
    <div className="relative w-full mx-auto">
      ...
      <div
        className={`fixed inset-0 bg-[#6EC4C2] flex justify-center items-start z-50 transition-transform duration-500 transform ${
          ...
          {sections.length > 0 ? (
            sections.map((section, sectionIndex) => (
              <div key={sectionIndex} className="mb-10">
                <h2 className="text-5xl font-bold mb-4">{section.heading}</h2>
