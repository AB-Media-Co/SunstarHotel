  ...
  return (
    <>
      <div className="relative w-full mx-auto">
        ...
        {/* Navigation buttons */}
        <button
          className="hidden md:block absolute top-1/2  left-0 md:left-20 transform bg-primary-yellow -translate-y-1/2 text-primary-white p-2 rounded-full"
          onClick={prevSlide}
        ...
        <button
          className="hidden md:block absolute top-1/2 r right-0 md:right-20 transform bg-primary-yellow -translate-y-1/2 text-primary-white p-2 rounded-full"
          onClick={nextSlide}
