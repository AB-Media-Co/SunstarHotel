...
const RoomsDescription = ({roomData}) => {
    ...
    return (
        <div className="w-full bg-primary-white py-4 md:py-6 md:px-8 lg:px-16">
            <div className="content gap-5 flex md:items-center flex-col lg:flex-row justify-between">
                ...
                <div className="lg:w-1/2 md:text-center lg:text-left flex flex-col gap-4">
                    <h1 className="text-mobile/h3 md:text-desktop/h3 text-reveal-animation font-bold">
                        Description
                    </h1>
                ...
                <img
                    ...
                    className="w-[500px] h-[350px] rounded-xl animation-on-scroll bg-cover"
                />
            </div>
        </div>
    );
