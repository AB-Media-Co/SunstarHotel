...
const RoomsDescription = () => {
    ...
    return (
        <div className={`w-full bg-white py-4  md:py-12  px-4 md:px-8 lg:px-16`}>
            <div className={`content gap-5 flex md:items-center section flex-col  lg:flex-row justify-between `}>
                {/* Text Section */}
                <div className="lg:w-1/2 md:text-center lg:text-left flex flex-col gap-4">
                    <h1 className={`text-[28px] md:text-[38px]  text-reveal-animation font-bold  `}>
                        Description
                    </h1>
                    <p className={` text-sm md:text-lg  animation-on-scroll leading-relaxed`}>
