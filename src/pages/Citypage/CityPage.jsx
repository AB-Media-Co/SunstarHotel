    ...
    return (
        <div className="bg-gray-100">
            ...
            <div className="relative overflow-hidden bg-cover bg-center h-96" style={{ backgroundImage: 'url("/images/HomepageImages/sec3CardImg.png")' }}>
                ...
                <div className="absolute inset-0 flex flex-col justify-center content  text-white">
                    <h1 className="text-4xl font-bold">Ahmedabad</h1>
                    <div className="mt-4">
                        <input type="date" className="bg-white text-gray-800 p-2 rounded-lg" />
                        <button className="bg-green-500 text-white p-2 ml-2 rounded-lg">Check Availability</button>
                    </div>
                </div>
            </div>
            ...
            <div className='content'>
                ...
                <section className="container mx-auto py-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white shadow-lg p-4 rounded-lg">
                            ...
                            <button className="bg-green-500 text-white p-2 mt-4 rounded-lg">Book Now</button>
                        </div>
                        <div className="bg-white shadow-lg p-4 rounded-lg">
                            <img src="/images/HomepageImages/sec3CardImg.png" alt="Featured Hotel" className="w-full h-48 object-cover rounded-lg mb-4" />
                ...
                <section className="container mx-auto py-8">
                    ...
                    <button className="bg-green-500 text-white p-2 mt-4 rounded-lg">Contact Us</button>
                </section>
                ...
                <section className="container mx-auto py-8">
                    ...
                    <button className="bg-green-500 text-white p-2 mt-4 rounded-lg">Join Us</button>
                </section>
                ...
                <div className="bg-green-500 text-white py-8">
                    <div className="container mx-auto text-center">
                        ...
                        <button className="bg-white text-green-500 p-2 mt-4 rounded-lg">Book Now</button>
                    </div>
                </div>
